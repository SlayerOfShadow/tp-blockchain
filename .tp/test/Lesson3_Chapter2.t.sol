            ...
            uint(
                vm.load(
                    ...
                    bytes32(
                        uint(
                            keccak256(
                                abi.encode(address(this), 5) // 5 is the slot of ownerZombieCount in ZombieFactory, and we are looking for address(this) key
                            )
                        )
                    )
                )
            ...
            uint(
                vm.load(
                    ...
                    bytes32(
                        uint(
                            keccak256(
                                abi.encode(address(42), 5) // 5 is the slot of ownerZombieCount in ZombieFactory, and we are looking for address(42) key
                            )
                        )
                    )
                )
